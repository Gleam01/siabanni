...
@section('styles')
  <link rel="stylesheet" href="{{asset('back-end/plugins/nestable/jquery-nestable.css')}}"/>
@stop
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Default</strong> Example <small>Drag & drop hierarchical list with mouse and touch compatibility</small> </h2>
                        <ul class="header-dropdown">
                            <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more"></i> </a>
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="javascript:void(0);">Action</a></li>
...
@section('scripts')
  <script src="{{asset('back-end/plugins/nestable/jquery.nestable.js')}}"></script> <!-- Jquery Nestable -->
  <script src="{{asset('back-end/js/pages/ui/sortable-nestable.js')}}"></script>
@stop
