    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Icons
                <small class="text-muted">Welcome to Oreo <a href="https://design.google.com/icons/" target="_blank">design.google.com/icons</a></small>
                </h2>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="row clearfix demo-icon-container">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="demo-google-material-icon"> <i class="zmdi zmdi-more-vert"></i> <span class="icon-name">more_vert</span> </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
