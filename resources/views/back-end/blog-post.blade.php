...
@section('styles')
  ...
  <link rel="stylesheet" href="{{asset('back-end/plugins/dropzone/dropzone.css')}}">
  <link rel="stylesheet" href="{{asset('back-end/plugins/bootstrap-select/css/bootstrap-select.css')}}" />
@stop
...
@section('scripts')
  ...
  <script src="{{asset('back-end/plugins/ckeditor/ckeditor.js')}}"></script> <!-- Ckeditor -->
