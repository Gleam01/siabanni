...
@section('styles')
  ...
  <link rel="stylesheet" href="{{asset('back-end/plugins/morrisjs/morris.min.css')}}" />
@stop
...
@section('scripts')
  ...
  <script src="{{asset('back-end/bundles/knob.bundle.js')}}"></script> <!-- Jquery Knob, Count To, Sparkline Js -->
