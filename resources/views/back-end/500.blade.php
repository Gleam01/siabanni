    ...
    <div class="container">
        ...
        <div class="navbar-collapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-white btn-round" href="{{route('back.sign-in')}}.html">SIGN IN</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="card-plain">
                <form class="form" method="" action="">
                    ...
                    <div class="footer text-center">
                        <a href="index.html" class="btn btn-primary btn-round btn-lg btn-block waves-effect waves-light">GO TO HOMEPAGE</a>
