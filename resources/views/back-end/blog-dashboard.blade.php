...
@section('styles')
<link rel="stylesheet" href="{{asset('back-end/plugins/jvectormap/jquery-jvectormap-2.0.3.css')}}"/>
                       ...
                       <ul class="inbox-widget list-unstyled clearfix">
                            <li class="inbox-inner"><a href="javascript:void(0);">
                               <div class="inbox-item">
                                   <div class="inbox-img"> <img src="{{asset('back-end/images/sm/avatar1.jpg')}}" class="rounded" alt=""> </div>
                            ...
                            <li class="inbox-inner"> <a href="javascript:void(0);">
                                <div class="inbox-item">
                                   <div class="inbox-img"> <img src="{{asset('back-end/images/sm/avatar2.jpg')}}" class="rounded" alt=""> </div>
                                   <div class="inbox-item-info">
                            ...
                            <li class="inbox-inner"> <a href="javascript:void(0);">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="{{asset('back-end/images/sm/avatar3.jpg')}}" class="rounded" alt=""> </div>
                                    <div class="inbox-item-info">
                            ...
                            <li class="inbox-inner"> <a href="javascript:void(0);">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="{{asset('back-end/images/sm/avatar4.jpg')}}" class="rounded" alt=""> </div>
                                    <div class="inbox-item-info">
                            ...
                            <li class="inbox-inner"> <a href="javascript:void(0);">
                                <div class="inbox-item">
                                    <div class="inbox-img"><img src="{{asset('back-end/images/sm/avatar5.jpg')}}" class="rounded" alt=""> </div>
                                    <div class="inbox-item-info">
                            ...
                            <li class="inbox-inner"> <a href="javascript:void(0);">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="{{asset('back-end/images/sm/avatar6.jpg')}}" class="rounded" alt=""> </div>
                                    <div class="inbox-item-info">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="card single_post">
                    ...
                    <div class="body">
                        ...
                        <a href="{{route(blog-details)}}" title="read more" class="btn btn-round btn-info">Read More</a>
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{asset('back-end/plugins/jvectormap/jquery-jvectormap-us-aea-en.js')}}"></script><!-- USA Map Js -->
...
<script src="{{asset('back-end/js/pages/blog/blog.js')}}"></script>
@stop
