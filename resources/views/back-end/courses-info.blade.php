            ...
            <div class="col-md-12 col-lg-4">
                <div class="card">
                    <div class="body">
                        ...
                        <a href="{{route('back.courses-info')}}" class="btn btn-block btn-raised btn-primary btn-round waves-effect" role="button">Apply Now</a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <img src="{{asset('back-end/images/image7.jpg')}}" alt="" class="img-fluid rounded m-b-30">
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <img src="{{asset('back-end/images/image2.jpg')}}" alt="" class="img-fluid rounded m-b-30">
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <img src="{{asset('back-end/images/image3.jpg')}}" alt="" class="img-fluid rounded m-b-30">
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <img src="{{asset('back-end/images/image4.jpg')}}" alt="" class="img-fluid rounded m-b-30">
                                    </div>
                                </div>
                            </div>
                        </div>
