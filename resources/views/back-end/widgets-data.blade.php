    ...
    <div class="container-fluid">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                                <div class="body">
                                    ...
                                    <p class="text-muted">MCA Student</p>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                                <div class="body">
                                    ...
                                    <p class="text-muted ">New Student 2018</p>
                                    <span id="linecustom2">2,9,5,5,8,5,4,2,6</span>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                                <div class="body">
                                    <h2 class="number count-to m-t-0 m-b-5" data-from="0" data-to="51" data-speed="2000" data-fresh-interval="700">51</h2>
                                    <p class="text-muted">New Professors</p>
        ...
        <div class="row clearfix">
            <div class="col-lg-4 col-md-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>USA</strong> New Student</h2>
                    </div>
                    <div class="body">
                        <div class="row">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>India</strong> New Student</h2>
                    </div>
                    <div class="body">
                        <div class="row">
                            <div class="col-sm-4 col-4 m-b-10">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Europe</strong> New Student</h2>
                    </div>
                    <div class="body">
                        <div class="row">
                            <div class="col-sm-4 col-4 m-b-10">
...
@section('scripts')
  <script src="{{asset('back-end/bundles/knob.bundle.js')}}"></script>
  <script src="{{asset('back-end/js/pages/widgets/infobox/infobox-1.js')}}"></script>
  <script src="{{asset('back-end/js/pages/charts/jquery-knob.js')}}"></script>
  <script src="{{asset('back-end/js/pages/cards/basic.js')}}"></script>
@stop
