                    ...
                    <div class="body">
                        ...
                        <p>
                            ...
                            <button class="btn btn-primary btn-round">
                                <i class="zmdi zmdi-favorite-outline"></i> With Icon
                            </button>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Left Font Icon">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Right Font Icon">
                                    <span class="input-group-addon">
                    ...
                    <div class="body m-b-20">
                        <div class="row">
                            <div class="col-sm-2">
                                ...
                                <img src="{{asset('back-end/images/lg/avatar1.jpg')}}" alt="Rounded Image" class="rounded">
                            </div>
                            <div class="col-sm-2">
                                <p class="category">Circle Image</p>
                                <img src="{{asset('back-end/images/lg/avatar1.jpg')}}" alt="Circle Image" class="rounded-circle">
                            </div>
                            <div class="col-sm-2">
                                <p class="category">Raised</p>
                                <img src="{{asset('back-end/images/lg/avatar1.jpg')}}" alt="Raised Image" class="rounded img-raised">
                            </div>
                            <div class="col-sm-2">
                                <p class="category">Circle Raised</p>
                                <img src="{{asset('back-end/images/lg/avatar1.jpg')}}" alt="Thumbnail Image" class="rounded-circle img-raised">
                            </div>
                        </div>
                    </div>
                </div>
