    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="media">
                                    <div class="float-left">
                                        <div class="m-r-20"> <img class="rounded" src="{{asset('back-end/images/xs/avatar7.jpg')}}" width="60" alt=""> </div>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <span><img src="{{asset('back-end/images/image2.jpg')}}" class="img-thumbnail m-t-10" width="250" alt=""></span>
                                <span><img src="{{asset('back-end/images/image3.jpg')}}" class="img-thumbnail m-t-10" width="250" alt=""></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="body">
                        <strong>Click here to</strong> <a href="{{route('back.mail-compose')}}">Reply</a> or <a href="{{route('back.mail-compose')}}">Forward</a>
                    </div>
                </div>
            </div>
        </div>
