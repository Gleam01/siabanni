...
@section('styles')
<link rel="stylesheet" href="{{asset('back-end/css/chatapp.css')}}">
@stop
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                ...
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="{{route('back.home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane stretchRight active" id="people">
                                <ul class="chat-list list-unstyled m-b-0">
                                    <li class="clearfix">
                                        <img src="{{asset('back-end/images/xs/avatar1.jpg')}}" alt="avatar" />
                                        <div class="about">
                            ...
                            <ul class="m-b-0">
                                ...
                                <li>
                                    ...
                                    <div class="message my-message">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-lg-4 m-t-10"><a href="javascript:void(0);"><img src="{{asset('back-end/images/image2.jpg')}}" alt="" class="img-fluid img-thumbnail"></a> </div>
                                            <div class="col-sm-6 col-lg-4 m-t-10"><a href="javascript:void(0);"> <img src="{{asset('back-end/images/image3.jpg')}}" alt="" class="img-fluid img-thumbnail"></a> </div>
                                            <div class="col-sm-6 col-lg-4 m-t-10"><a href="javascript:void(0);"> <img src="{{asset('back-end/images/image4.jpg')}}" alt="" class="img-fluid img-thumbnail"> </a> </div>
                                        </div>
                                    </div>
                                </li>
                                <li>
