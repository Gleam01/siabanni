                ...
                <form class="form" method="" action="">
                    <div class="header">
                        <div class="logo-container">
                            <img class="rounded-circle img-raised" src="{{asset('back-end/images/profile_av.jpg')}}" alt="">
                        </div>
                        <h5>Charlotte</h5>
                        <span>Locked</span>
                    </div>
                    ...
                    <div class="footer text-center">
                        <a href="{{route('back.sign-in')}}" class="btn btn-primary btn-round btn-lg btn-block waves-effect waves-light">LOG IN</a>
