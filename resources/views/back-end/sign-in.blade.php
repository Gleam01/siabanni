    ...
    <div class="container">
        ...
        <div class="navbar-collapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-white btn-round" href="{{route('back.sign-up')}}">SIGN UP</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="card-plain">
                <form class="form" method="" action="">
                    ...
                    <div class="footer text-center">
                        <a href="{{route('back.home')}}" class="btn btn-primary btn-round btn-lg btn-block ">SIGN IN</a>
                        <h5><a href="{{route('back.forgot-password')}}" class="link">Forgot Password?</a></h5>
                    </div>
                </form>
            </div>
        </div>
