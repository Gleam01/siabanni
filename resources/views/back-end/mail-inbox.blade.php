                    ...
                    <li class="list-group-item unread">
                        <div class="media">
                            <div class="pull-left">
                                ...
                                <div class="thumb hidden-sm-down m-r-20"> <img src="{{asset('back-end/images/xs/avatar2.jpg')}}" class="rounded-circle" alt=""> </div>
                            </div>
                            <div class="media-body">
                                <div class="media-heading">
                                    <a href="{{route('back.mail-single')}}" class="m-r-10">Simply dummy text</a>
                    ...
                    <li class="list-group-item">
                        <div class="media">
                            <div class="pull-left">
                                ...
                                <div class="thumb hidden-sm-down m-r-20"> <img src="{{asset('back-end/images/xs/avatar5.jpg')}}" class="rounded-circle" alt=""> </div>
                            </div>
                            <div class="media-body">
                                <div class="media-heading">
                                    <a href="{{route('back.mail-single')}}" class="m-r-10">Generators on the Internet</a>
                    ...
                    <li class="list-group-item">
                        <div class="media">
                            <div class="pull-left">
                                ...
                                <div class="thumb hidden-sm-down m-r-20"> <img src="{{asset('back-end/images/xs/avatar6.jpg')}}" class="rounded-circle" alt=""> </div>
                            </div>
                            <div class="media-body">
                                <div class="media-heading">
                                    <a href="{{route('back.mail-single')}}" class="m-r-10">Contrary to popular</a>
                                    <span class="badge bg-blush">Themeforest</span>
                                    <small class="float-right text-muted"><time class="hidden-sm-down" datetime="2017">12:35 AM</time><i class="zmdi zmdi-attachment-alt"></i> </small>
                                </div>
                    ...
                    <li class="list-group-item">
                        <div class="media">
                            <div class="pull-left">
                                ...
                                <div class="thumb hidden-sm-down m-r-20"> <img src="{{asset('back-end/images/xs/avatar7.jpg')}}" class="rounded-circle" alt=""> </div>
                            </div>
                            <div class="media-body">
                                <div class="media-heading">
                                    <a href="{{route('back.mail-single')}}" class="m-r-10">Velit a labore</a>
                    ...
                    <li class="list-group-item">
                        <div class="media">
                            <div class="pull-left">
                                ...
                                <div class="thumb hidden-sm-down m-r-20"> <img src="{{asset('back-end/images/xs/avatar8.jpg')}}" class="rounded-circle" alt=""> </div>
                            </div>
                            <div class="media-body">
                                <div class="media-heading">
                                    <a href="{{route('back.mail-single')}}" class="m-r-10">Variations of passages</a>
                    ...
                    <li class="list-group-item">
                        <div class="media">
                            <div class="pull-left">
                                ...
                                <div class="thumb hidden-sm-down m-r-20"> <img src="{{asset('back-end/images/xs/avatar9.jpg')}}" class="rounded-circle" alt=""> </div>
                            </div>
                            <div class="media-body">
                                <div class="media-heading">
                                    <a href="{{route('back.mail-single')}}" class="m-r-10">Generators on the Internet</a>
                    ...
                    <li class="list-group-item">
                        <div class="media">
                            <div class="pull-left">
                                ...
                                <div class="thumb hidden-sm-down m-r-20"> <img src="{{asset('back-end/images/xs/avatar10.jpg')}}" class="rounded-circle" alt=""> </div>
                            </div>
                            <div class="media-body">
                                <div class="media-heading">
                                    <a href="{{route('back.mail-single')}}" class="m-r-10">Velit a labore</a>
