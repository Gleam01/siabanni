            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-default credit-card-box">
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" action="{{ route('admission.store') }}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
                            @csrf
        ...
        $(function() {
            ...
            function stripeResponseHandler(status, response) {
                if (response.error) {
                    ...
                    $form.append('<input class="form-control card-expiry-year" name="amount" value="{{ $training->admissionFees }}" type="hidden">');
                    $form.get(0).submit();
                }
            }  
        });
