            ...
            <div class="row justify-content-between">
                <div class="col-lg-5 col-md-12">
                    <div class="box-img box-shadow m-b-20">
                        <img src="http://via.placeholder.com/468x300" alt="">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="page-text">
                        <div class="section-top">
                            <p><strong>Oreo University</strong> isIt is a long established fact that a reader will be
                ...
                <div class="col-md-7">
                    <div class="map-area">
                        ...
                        <div class="our-history-img">
                            <img src="http://via.placeholder.com/670x310" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="team-box text-center">
                        <div class="doctor-pic"><img src="http://via.placeholder.com/280x260" alt="Pro. John"></div>
                        <div class="team-info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="team-box text-center">
                        <div class="doctor-pic"><img src="http://via.placeholder.com/280x260" alt="Pro. Amelia"></div>
                        <div class="team-info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="team-box text-center">
                        <div class="doctor-pic"><img src="http://via.placeholder.com/280x260" alt="Pro. Jack"></div>
                        <div class="team-info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="team-box text-center">
                        <div class="doctor-pic"><img src="http://via.placeholder.com/280x260" alt="Pro. Charlie"></div>
                        <div class="team-info">
