        ...
        <div class="row">
            <div class="col-lg-4 col-md-12">
                <div class="fcard about">
                    ...
                    <div class="social">
                        <a href=""><i class="zmdi zmdi-facebook m-r-10"></i></a>
                        <a href=""><i class="zmdi zmdi-twitter m-r-10"></i></a>
                        <a href=""><i class="zmdi zmdi-instagram m-r-10"></i></a>
                        <a href=""><i class="zmdi zmdi-linkedin-box m-r-10"></i></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <ul class="list-unstyled">
                                ...
                                <li><a href="teachers.blade.php">Teacher</a></li>
                                <li><a href="event.blade.php">Events</a></li>
                                <li><a href="galary.blade.php">Gallery</a></li>
