...
<section id="hero">
    <div class="inner-banner" style="background-image:url(assets/images/banner-service.png)">
        <div class="container">
            <h3 class="title">About Us<br><big>Oreo <strong>University</strong></big></h3>
        </div>
    </div>
</section>
        ...
        <div class="container">
            <div class="row">
                <div class="section-title col-12">
                    <h2><span>Welcome </span>Oreo University</h2>
    ...
    <div class="what-we-do">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="what-we-box">
                        <i class="zmdi zmdi-University-alt"></i>
                        <h6>Modren Clinic</h6>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 text-md-right text-sm-center">
                    <a class="btn btn-primary btn-round" href="javascript:void(0);">Enquiry</a>
                </div>
            </div>
        </div>
    </div>
