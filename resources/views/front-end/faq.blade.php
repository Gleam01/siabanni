                    ...
                    <div class="panel-group" id="accordion_1" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading" role="tab" id="headingfour_4">
                                <h4 class="panel-title"><a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_4" href="#collapsefour_4" aria-expanded="false" aria-controls="collapsefour_4">Where is my missing course?</a></h4>
                            </div>
                            <div id="collapsefour_4" class="panel-collapse collapse" role="tabpanel"
                                 aria-labelledby="headingfour_4">
                                <div class="panel-body">It is a long established fact that a reader will be
                                    distracted by the readable content of a page when looking at its layout. The
                                    point of using Lorem Ipsum is that it has a more-or-less normal distribution of
                                    letters, as opposed to using 'Content here, content here', making it look like
                                    ...
                                    over the years, sometimes by accident, sometimes on purpose (injected humour and
                                    the like).
                                    <img src="http://via.placeholder.com/1220x310" class="m-t-10" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
